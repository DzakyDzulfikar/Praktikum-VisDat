...
# Streamlit App (Alternatif dengan Matplotlib)
...
bars = ax.bar(['Ilmu Komputer', 'Sistem Informasi', 'Teknik Informatika', 'Data Science'], 
              [120, 150, 100, 80], color=colors)
ax.set_title('Jumlah Mahasiswa per Jurusan')
ax.set_xlabel('Jurusan')
ax.set_ylabel('Jumlah Mahasiswa')
...
# Streamlit Title for Next Graph
st.title("Multiple Basic Bar Chart")

# Data tambahan
data_2023 = [120, 150, 100, 80]
data_2024 = [140, 160, 110, 90]
x = range(len(['Ilmu Komputer', 'Sistem Informasi', 'Teknik Informatika', 'Data Science']))
width = 0.4
...
ax.set_xticklabels(['Ilmu Komputer', 'Sistem Informasi', 'Teknik Informatika', 'Data Science'])
ax.legend()
